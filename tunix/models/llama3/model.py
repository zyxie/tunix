  ...
  def to_hf_mappings():
    if os.environ.get("NEW_MODEL_DESIGN") == "True":
      return {
        ...
        "embedder.input_embedding": ("embedder.input_embedding_table_VD", ("model", None)),
  ...
  def lora_to_hf_mappings():
    if os.environ.get("NEW_MODEL_DESIGN") == "True":
      ...
      return {
          ...
          "layers.*.attn.q_proj.w_lora_a": ("layers.*.self_attn.q_proj.kernel_lora_a",("model", None)),
          "layers.*.attn.q_proj.w_lora_b": ("layers.*.self_attn.q_proj.kernel_lora_b",(None, None)),
          "layers.*.attn.k_proj.w_lora_a": ("layers.*.self_attn.k_proj.kernel_lora_a",("model", None)),
          "layers.*.attn.k_proj.w_lora_b": ("layers.*.self_attn.k_proj.kernel_lora_b",(None, None)),
          "layers.*.attn.v_proj.w_lora_a": ("layers.*.self_attn.v_proj.kernel_lora_a",("model", None)),
          "layers.*.attn.v_proj.w_lora_b": ("layers.*.self_attn.v_proj.kernel_lora_b",(None, None)),
          "layers.*.attn.o_proj.w_lora_a": ("layers.*.self_attn.o_proj.kernel_lora_a",("model", None)),
          "layers.*.attn.o_proj.w_lora_b": ("layers.*.self_attn.o_proj.kernel_lora_b",(None, None))
        }
